document.querySelector(".main-archivo").innerHTML+= `<div class="carga"></div>`;
...
.then((data)=>{
    ...
    let cards = document.querySelector(".cardArch");
    console.log(cards);
    cards.innerHTML="";
    for(let card of data){
        cards.innerHTML+= `
        <div class="cardArch-item item-${card.id}">
            <div class="card-p">
            ...
            <div class="margin-btn-arch">
                <button class="btn-arch" onclick="consulta('/api/updateCard/${card.id}','PUT',{state:'A'})">
                ...
                <button class="btn-arch" onclick="consulta('/api/updateCard/${card.id}','PUT',{state:'E'})">
